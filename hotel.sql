...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Mar 26, 2025 at 11:17 PM
...
(37, 'LUX-2025-4ABA7528C9', 'Arturo Yparraguirre', 'Social Security', 'profile1.jpg', '531297', '09099366481', 'arturoyparraguirre01@gmail.com', 'art', 'Activated', 'profile1.jpg', 0, NULL, 'User');
...
INSERT INTO `inquiry` (`inquiry_id`, `date`, `time`, `name`, `email`, `inquiry`, `remarks`, `status`) VALUES
(122473, '2025-03-26', '01:22:20', 'Arturo Yparraguirre', 'arturoyparraguirre01@gmail.com', 'cxz', 'test', 'Confirmed');
...
(693568, '58', '[\"Shoe Bag (₱450 x 1)\",\"Shoe Brush (₱135 x 1)\"]', '[\"yawa (₱200)\"]', '785', 'cancelled'),
(993690, '62', '[\"Spaghetti (₱185 x 2)\",\"Iced Coffee (₱75 x 2)\",\"French Fries (₱55 x 1)\",\"Meal (₱250 x 5)\",\"Coca Cola (₱65 x 2)\",\"Red Wine (₱95 x 1)\",\"Orange Juice (₱45 x 1)\"]', '[\"Swimming Pool (₱200)\",\"Tennis Court (₱280)\",\"Basket Ball Court (₱280)\"]', '2855', 'pending');
...
(62, 37, 10, '2025-03-26', '2025-04-15', 'Gcash', 'Arturo Yparraguirre Sr.', '09099366481', '12345678901', 'logo1.png', 50000.00, 'Online', 'confirmed', '2025-03-26 11:29:57'),
(63, 38, 14, '2025-03-28', '2025-03-29', 'Gcash', 'Arturo Yparraguirre Sr.', '09099366481', '12345678901', 'profile2.jpg', 8000.00, 'Online', 'confirmed', '2025-03-26 12:39:29');
...
(10, 'Breeze Garden', '101', 'This is just a sample description.', 2, 1, 'Deluxe Room', 2500, 'Available', 'rooms.jpg', '2025-01-12 22:35:21'),
(14, 'Luxe Grand Room', 'Room 501', 'This is just a sample description.', 3, 2, 'Standard Rooms', 8000, 'Available', 'double.jpg', '2025-01-14 14:03:45'),
(15, 'Crimson Room', 'Room 502', 'This is just a sample description.', 8, 4, 'Presidential Suite Room', 12500, 'Available', 'image.jpg', '2025-01-14 14:11:29');
...
(23, 'CAT-349C', 'Exclusive', 'Feels good', '2025-03-24 23:09:42'),
(31, 'CAT-0A21', 'Presidential Suite Room', 'Elegant Rooms', '2025-03-27 05:02:58');
...
(0, 'Marriott', '67b882cfed730_banner1.jpg', 'banner2.jpg', 'banner3.jpg', 'hrms', 'Welcome to Luxe Haven Hotel – Where Elegance Meets Comfort. Located in the heart of your dream destination, our opulent suites, world-class dining, and exclusive amenities are crafted for relaxation and sophistication. Whether for leisure or business, enjoy personalized service and exquisite surroundings for an unforgettable stay.', 'Luxe Haven started as a small boutique hotel catering to discerning guests seeking an intimate and personalized stay. Over the years, our commitment to excellence earned us a reputation as one of the most sought-after destinations for both leisure and business travelers.', 'As our guests’ trust and loyalty grew, so did our vision. Luxe Haven expanded its offerings, introducing state-of-the-art facilities, luxurious suites, fine dining restaurants, and wellness amenities. By 2015, we proudly became a premier destination for international travelers, hosting memorable weddings, corporate events, and once-in-a-lifetime celebrations.', 'At Luxe Haven, we believe in creating moments that matter. We combine modern elegance with touches of traditional Filipino culture, showcasing the beauty of the Philippines while offering unparalleled comfort. We strive to provide not just a stay, but an experience. Whether you’re here for a relaxing escape, a business trip, or a special occasion, Luxe Haven Hotel PH promises exceptional service, luxurious accommodations, and unforgettable memories.', 'Our Beginnings', 'Our Growth and Achievements', 'Our Philosophy and Promise', '67e3ce2ed2a3e_png-transparent-marriott-logo-marriott-international-hotel-logo-company-accommodation-hotel-text-business-resort-removebg-preview.png', '67e47a157230a_png-transparent-marriott-logo-marriott-international-hotel-logo-company-accommodation-hotel-text-business-resort-removebg-preview.png', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15836.740674923267!2d125.62401962280275!3d7.1045270521117505!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32f96d0049e72b93%3A0x81d9f9e13b142b44!2sAmerican%20Backyard!5e0!3m2!1sen!2sph!4v1742561295797!5m2!1sen!2sph\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', 'luxehotelsss@gmail.com', '09099366481', '#f2f2f2', '#a23939', '#d2a7a7', 'about1.jpg', 'about2.jpg', 'about3.jpg');
...
(812129, 14, 'Arturo Yparraguirre Jr', 'arturoyparraguirre01@gmail.com', '09519237937', 'Bangkal', 'Others', '1742980099_67e3c4032bf65_rooms.jpg', '2025-03-28', '2025-04-01', 'cash', NULL, NULL, NULL, '', 32000.00, 5000.00, 3000.00, 'Downpayment', 'Walk-in', 'confirmed');
...
--
ALTER TABLE `rooms`
  MODIFY `room_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
